  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-10">
        <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 hover:shadow-md transition-shadow flex flex-col items-center">
        ...
        <div className="mb-10">
          ...
          {displayedMatches.length === 0 ? (
            ...
            {displayedMatches.map(job => {
              ...
              return (
                <div key={job.id} className="bg-white dark:bg-slate-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-slate-800 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border-l-4 border-l-yellow-400">
